                ...
                <table class="table table-bordered table-striped table-hover DataTable" id="DataTable" style="width: 100%">
                  <thead>
                    ...
                    <tr>
                      ...
                      <th>#</th>
                      <th id="filter">nama_jenis_tes</th>
                    </tr>
                  </thead>
                </table>
              </div>
              ...
              <div class="card-header">
                ...
                <div class="card-body">
                  <form id="form">
                    ...
                    <div class="form-group">
                      <label>Nama</label>
                      <input type="text" class="form-control" name="nama_jenis_tes" ng-model="form.nama_jenis_tes" placeholder="Enter Nama Jenis Tes" required>
                    </div>
                ...
                <div class="table-responsive">
                    <table class="table-detail table" style="width: 100%">
                        <tr>
                            ...
                            <th width="1%">:</th>
                            <th>{{detailData.nama_jenis_tes}}</th>
                        </tr>
                    </table>
                </div>
              </div>
...
<script type="text/javascript">
    ...
    var table = "";
    var module_api = "<?php echo site_url() ?>jenis_tes/";
    var box1 = $('#box1');
    var box2 = $('#box2');
    var box3 = $('#box3');
            ...
            $timeout(function() {
                table = $('#DataTable').DataTable({
                    ...
                    'ajax': {
                        ...
                        type:"POST",
                        data:function(d){
                            d.nama_jenis_tes = $scope.filter.nama_jenis_tes;
                        },
            ...
            $.ajax({
                ...
                success:function(data){
                    if (data.error == 0) {
                        var d = data.data[0];
                        $('[name=id]').val(d.id);
                        $('[name=nama_jenis_tes]').val(d.nama_jenis_tes);
