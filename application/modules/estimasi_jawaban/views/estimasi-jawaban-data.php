                ...
                <div class="row">        
                    <div class="col-md-4 offset-md-4">
                        <div class="form-group">
                          ...
                          <select class="select2bs4" name="filter_jumlah_soal" ng-model="filter.jumlah_soal" ng-change="FilterTable()" style="width: 100%">
              ...
              <div class="card-header">
                ...
                <div class="card-body">
                  <form id="form">
                    ...
                    <div class="form-group">
                      <label>Jumlah Soal</label>
                      <select class="select2bs4" name="jumlah_soal" ng-model="form.jumlah_soal" required style="width: 100%;">
                        <option value="">Pilih</option>
                        <?php foreach ($listJumlahSoal->result() as $value): ?>
                          <option value="<?php echo $value->jumlah_soal ?>"><?php echo $value->jumlah_soal ?></option>
                        <?php endforeach ?>
                    ...
                    <div class="form-group">
                      <label>No 1</label>
                      <input type="text" class="form-control" name="no1" ng-model="form.no1" placeholder="Enter No 1" required>
                    </div>
                    <div class="form-group">
                      <label>No 2</label>
                      <input type="text" class="form-control" name="no2" ng-model="form.no2" placeholder="Enter No 2" required>
                    </div>
                    <div class="form-group">
                      <label>No 3</label>
                      <input type="text" class="form-control" name="no3" ng-model="form.no3" placeholder="Enter No 3" required>
                    </div>
                    <div class="form-group">
                      <label>No 4</label>
                      <input type="text" class="form-control" name="no4" ng-model="form.no4" placeholder="Enter No 4" required>
                    </div>
                    <div class="form-group">
                      <label>No 5</label>
                      <input type="text" class="form-control" name="no5" ng-model="form.no5" placeholder="Enter No 5" required>
                    </div>
                    <div class="form-group" ng-show="form.jumlah_soal >= 6">
                      <label>No 6</label>
                      <input type="text" class="form-control" name="no6" ng-model="form.no6" placeholder="Enter No 6" ng-required="form.jumlah_soal >= 6">
                    </div>
                    <div class="form-group" ng-show="form.jumlah_soal >= 7">
                      <label>No 7</label>
                      <input type="text" class="form-control" name="no7" ng-model="form.no7" placeholder="Enter No 7" ng-required="form.jumlah_soal >= 7">
                    </div>
                    <div class="form-group">
                      <label>Jumlah Benar</label>
                      <input type="text" class="form-control" name="jumlah" ng-model="form.jumlah" placeholder="Enter Jumlah Benar" required>
                    </div>
                    <div class="form-group">
                      <label>Urutan</label>
                      <input type="text" class="form-control" name="sequence" ng-model="form.sequence" placeholder="Enter Urutan" required>
                    </div>
              ...
              <div class="card-body">
                ...
                <div class="table-responsive">
                  <table class="table-detail table" style="width: 100%">
                    <tr>
                      <th width="8%">Jumlah Soal</th>
                      <th width="1%">:</th>
                      <th>{{detailData.jumlah_soal}}</th>
                    </tr>
                    <tr>
                      <th>No 1</th>
                      <th>:</th>
                      <th>{{detailData.no1}}</th>
                    </tr>
                    <tr>
                      <th>No 2</th>
                      <th>:</th>
                      <th>{{detailData.no2}}</th>
                    </tr>
                    <tr>
                      <th>No 3</th>
                      <th>:</th>
                      <th>{{detailData.no3}}</th>
                    </tr>
                    <tr>
                      <th>No 4</th>
                      <th>:</th>
                      <th>{{detailData.no4}}</th>
                    </tr>
                    <tr>
                      <th>No 5</th>
                      <th>:</th>
                      <th>{{detailData.no5}}</th>
                    </tr>
                    <tr ng-show="detailData.jumlah_soal >= 6">
                      <th>No 6</th>
                      <th>:</th>
                      <th>{{detailData.no6}}</th>
                    </tr>
                    <tr ng-show="detailData.jumlah_soal >= 7">
                      <th>No 7</th>
                      <th>:</th>
                      <th>{{detailData.no7}}</th>
                    </tr>
                    <tr>
                      <th>Jumlah Benar</th>
                      <th>:</th>
                      <th>{{detailData.jumlah}}</th>
                    </tr>
                    <tr>
                      <th>Urutan</th>
                      <th>:</th>
...
<script type="text/javascript">
    ...
    var table = "";
    var module_api = "<?php echo site_url() ?>estimasi_jawaban/";
    var box1 = $('#box1');
    var box2 = $('#box2');
    var box3 = $('#box3');
                ...
                table = $('#DataTable').DataTable({
                    ...
                    'ajax': {
                        ...
                        data:function(d){
                            ...
                            d.no1 = $scope.filter.no1;
                            d.no2 = $scope.filter.no2;
                            d.no3 = $scope.filter.no3;
                            d.no4 = $scope.filter.no4;
                            d.no5 = $scope.filter.no5;
                            d.no6 = $scope.filter.no6;
                            d.no7 = $scope.filter.no7;
                            d.jumlah = $scope.filter.jumlah;
                            d.sequence = $scope.filter.sequence;
                        },
