              ...
              <div class="card-header">
                ...
                <div class="card-body">
                  <form id="form">
                    ...
                    <div class="form-group">
                      <label>Nama</label>
                      <input type="text" class="form-control" name="nama_tingkat" ng-model="form.nama_tingkat" placeholder="Enter Nama Tingkat" required>
                    </div>
                    <div class="form-group">
                      <label>Urutan</label>
...
<script type="text/javascript">
    ...
    var table = "";
    var module_api = "<?php echo site_url() ?>tingkat/";
    var box1 = $('#box1');
    var box2 = $('#box2');
    var box3 = $('#box3');
            ...
            $.ajax({
                ...
                success:function(data){
                    if (data.error == 0) {
                        var d = data.data[0];
                        $('[name=id]').val(d.id);
                        $('[name=nama_tingkat]').val(d.nama_tingkat);
