                ...
                <table class="table table-bordered table-striped table-hover DataTable" id="DataTable" style="width: 100%">
                  <thead>
                    <tr>
                      ...
                      <th width="">Jenis Peserta</th>
                      <th width="">Tujuan Tes</th>
                    ...
                    <tr>
                      ...
                      <th>#</th>
                      <th id="filter">nopendaftaran</th>
                      <th id="filter">nama_peserta</th>
                      <th id="filter">jenis_kelamin</th>
                      <th id="filter">nama_jenis_peserta</th>
                      <th id="filter">nama_tujuan_tes</th>
                ...
                <div class="card-body">
                  <form id="form">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="nama_peserta" ng-model="form.nama_peserta" placeholder="Enter Nama Peserta" required>
                    </div>
                ...
                <div class="table-responsive">
                    <table class="table-detail table" style="width: 100%">
                        <tr>
                            ...
                            <th width="1%">:</th>
                            <td>{{detailData.nopendaftaran}}</td>
                        </tr>
                        <tr>
                            <th>Nama Peserta</th>
                            <th>:</th>
                            <td>{{detailData.nama_peserta}}</td>
                        </tr>
                    </table>
                </div>
              </div>
...
<script type="text/javascript">
    ...
    var table = "";
    var module_api = "<?php echo site_url() ?>peserta/";
    var box1 = $('#box1');
    var box2 = $('#box2');
    var box3 = $('#box3');
            ...
            $timeout(function() {
                table = $('#DataTable').DataTable({
                    ...
                    'ajax': {
                        ...
                        type:"POST",
                        data:function(d){
                            d.nopendaftaran = $scope.filter.nopendaftaran;
                            d.nama_peserta = $scope.filter.nama_peserta;
                            d.jenis_kelamin = $scope.filter.jenis_kelamin;
                            d.nama_jenis_peserta = $scope.filter.nama_jenis_peserta;
                            d.nama_tujuan_tes = $scope.filter.nama_tujuan_tes;
                    ...
                    "columns": [
                        ...
                        { "data": "nama_peserta"},
                        { "data": "jenis_kelamin"},
                        { "data": "nama_jenis_peserta"},
                        { "data": "nama_tujuan_tes"},
                        { "data": "tanggal"},
                    ],
                    "columnDefs": [ 
                        {
            ...
            $.ajax({
                ...
                success:function(data){
                    if (data.error == 0) {
                        var d = data.data[0];
                        $('[name=id]').val(d.id);
                        $('[name=nama_peserta]').val(d.nama_peserta);
