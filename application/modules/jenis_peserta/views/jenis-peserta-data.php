              ...
              <div class="card-header">
                ...
                <div class="card-body">
                  <form id="form">
                    ...
                    <div class="form-group">
                      <label>Kode</label>
                      <input type="text" class="form-control" name="kode" ng-model="form.kode" placeholder="Enter Kode" required>
                    </div>
                    <div class="form-group">
                      <label>Nama</label>
                      <input type="text" class="form-control" name="nama_jenis_peserta" ng-model="form.nama_jenis_peserta" placeholder="Enter Nama Jenis Peserta" required>
                    </div>
                ...
                <div class="table-responsive">
                  <table class="table-detail table" style="width: 100%">
                    <tr>
                      <th width="8%">Kode</th>
                      <th width="1%">:</th>
                      <th>{{detailData.kode}}</th>
                    </tr>
                    <tr>
                      <th>Jenis Peserta</th>
                      <th>:</th>
                      <th>{{detailData.nama_jenis_peserta}}</th>
                    </tr>
                  </table>
                </div>
              </div>
...
<script type="text/javascript">
    ...
    var table = "";
    var module_api = "<?php echo site_url() ?>jenis_peserta/";
    var box1 = $('#box1');
    var box2 = $('#box2');
    var box3 = $('#box3');
            ...
            $.ajax({
                ...
                success:function(data){
                    if (data.error == 0) {
                        ...
                        $('[name=nama_jenis_peserta]').val(d.nama_jenis_peserta);
