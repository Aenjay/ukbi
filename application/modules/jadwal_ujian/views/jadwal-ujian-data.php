                ...
                <table class="table table-bordered table-striped table-hover DataTable" id="DataTable" style="width: 100%">
                  <thead>
                    ...
                    <tr>
                      ...
                      <th>#</th>
                      <th id="filter">nama_lokasi_ujian</th>
                      <th id="filter">tanggal</th>
                      <th id="filter">keterangan</th>
                    </tr>
                  </thead>
                </table>
              </div>
                ...
                <div class="card-body">
                  <form id="form">
                    ...
                    <div class="form-group">
                      ...
                      <select class="select2bs4" name="lokasi_ujian_id" ng-model="form.lokasi_ujian_id" required style="width: 100%;">
                        <option value="">Pilih</option>
                        <?php foreach ($listLokasiUjian->result() as $value): ?>
                          <option value="<?php echo $value->id ?>"><?php echo $value->nama_lokasi_ujian ?></option>
                        <?php endforeach ?>
                      </select>
                    </div>
                    <div class="form-group">
                      <label>Tanggal</label>
                      <input type="date" class="form-control" name="tanggal" ng-model="form.tanggal" placeholder="Enter Tanggal" required>
                    </div>
                    <div class="form-group">
                      <label>Keterangan</label>
                      <input type="text" class="form-control" name="keterangan" ng-model="form.keterangan" placeholder="Enter Keterangan">
                    </div>
              ...
              <div class="card-body">
                ...
                <div class="table-responsive">
                  <table class="table-detail table" style="width: 100%">
                    <tr>
                        <th width="8%">Lokasi Ujian</th>
                        <th width="1%">:</th>
                        <th>{{detailData.nama_lokasi_ujian}}</th>
                    </tr>
                    <tr>
                        <th>Tanggal</th>
                        <th>:</th>
                        <th>{{detailData.tanggal}}</th>
                    </tr>
                    <tr>
                        <th>Keterangan</th>
                        <th>:</th>
                        <th>{{detailData.keterangan}}</th>
                    </tr>
                  </table>
                </div>
              </div>
...
<script type="text/javascript">
    ...
    var table = "";
    var module_api = "<?php echo site_url() ?>jadwal_ujian/";
    var box1 = $('#box1');
    var box2 = $('#box2');
    var box3 = $('#box3');
            ...
            $timeout(function() {
                table = $('#DataTable').DataTable({
                    ...
                    'ajax': {
                        ...
                        type:"POST",
                        data:function(d){
                            d.nama_lokasi_ujian = $scope.filter.nama_lokasi_ujian;
                            d.tanggal = $scope.filter.tanggal;
                            d.keterangan = $scope.filter.keterangan;
                        },
            ...
            $.ajax({
                ...
                success:function(data){
                    if (data.error == 0) {
                        var d = data.data[0];
                        $('[name=id]').val(d.id);
                        $('[name=lokasi_ujian_id]').val(d.lokasi_ujian_id);
