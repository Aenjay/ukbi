...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" id="css-main" href="assets/custom.css">      
        <!-- END Stylesheets -->
    </head>
    <body>
        <!-- Page Container -->
        ...
        <div id="page-container" class="sidebar-dark side-scroll page-header-fixed page-header-dark main-content-boxed">
            ...
            <header id="page-header">
                ...
                <div class="content-header">
                    ...
                    <div>
                        ...
                        <a href="<?php echo site_url('dashboard') ?>" class="btn btn-sm btn-primary"><i class="fas fa-sign-in-alt"></i> Masuk</a>
            ...
            <main id="main-container">
               ...
               <div class="bg-image" style="background-image: url('assets/images/background.jpg');">
                   <div class="bg-black-75">
                       <div class="content py-6">
                           <div class="row pt-3">
                            <div class="col-md py-3 d-md-flex align-items-md-center text-left">
                              <img src="assets/images/logo-tutwuri.png" class="mr-3" alt="" width="75">
