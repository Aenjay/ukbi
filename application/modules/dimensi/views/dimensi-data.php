              ...
              <div class="card-header">
                ...
                <div class="card-body">
                  <form id="form">
                    ...
                    <div class="form-group">
                      <label>Nama</label>
                      <input type="text" class="form-control" name="nama_dimensi" ng-model="form.nama_dimensi" placeholder="Enter Nama Dimensi" required>
                    </div>
                    <div class="form-group">
                      <label>Urutan</label>
                    ...
                    <div class="card card-widget widget-user-2">
                      <div class="card-footer p-0">
                        <ul class="nav flex-column">
                          <li class="nav-item" ng-repeat="(key, value) in listDimensiTingkat">
                            <span href="#" class="nav-link">
                              {{value.nama_dimensi+' '+value.nama_tingkat}}
                            </span>
                          </li>
                        </ul>
                      </div>
...
<script type="text/javascript">
    ...
    var table = "";
    var module_api = "<?php echo site_url() ?>dimensi/";
    var box1 = $('#box1');
    var box2 = $('#box2');
    var box3 = $('#box3');
    ...
    app.controller('MasterController', function ($scope, $compile, $timeout, $http, $rootScope, $filter) {
            ...
            $.ajax({
                ...
                success:function(data){
                    if (data.error == 0) {
                        var d = data.data[0];
                        $('[name=id]').val(d.id);
                        $('[name=nama_dimensi]').val(d.nama_dimensi);
        ...
        $scope.GetDimensiTingkat = function(value){
          $scope.listDimensiTingkat = [];
          $.ajax({
              url:module_api+"tingkat",
              type:'GET',
              data:{
                dimensi_id:value,
              },
