              ...
              <div class="card-header">
                ...
                <div class="card-body">
                  <form id="form">
                    ...
                    <div class="form-group">
                      <label>Nama</label>
                      <input type="text" class="form-control" name="nama_tujuan_tes" ng-model="form.nama_tujuan_tes" placeholder="Enter Nama Tujuan Tes" required>
                    </div>
                ...
                <div class="table-responsive">
                    <table class="table-detail table" style="width: 100%">
                        <tr>
                            ...
                            <th width="1%">:</th>
                            <th>{{detailData.nama_tujuan_tes}}</th>
                        </tr>
                    </table>
                </div>
              </div>
...
<script type="text/javascript">
    ...
    var table = "";
    var module_api = "<?php echo site_url() ?>tujuan_tes/";
    var box1 = $('#box1');
    var box2 = $('#box2');
    var box3 = $('#box3');
            ...
            $.ajax({
                ...
                success:function(data){
                    if (data.error == 0) {
                        var d = data.data[0];
                        $('[name=id]').val(d.id);
                        $('[name=nama_tujuan_tes]').val(d.nama_tujuan_tes);
