...
class Lokasi_ujian_model extends CI_Model {

	var $table = 'ref_lokasi_ujian';
	var $column_order = array(null,null, null, 'nama_lokasi_ujian');
	var $column_search = array('nama_lokasi_ujian');
	var $order_default = "nama_lokasi_ujian asc";

	private function _get_datatables_query()
	{
		$this->db->select('id, nama_lokasi_ujian, allow_detail, allow_edit, allow_delete');
